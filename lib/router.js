...
Router.configure({
  ...
  onBeforeAction: function() {
      $("body").toggleClass("modal-pane-open", false);
...
Meteor.startup(function () {
  ...
  Router.map(function() {
    ...
    this.route('post_page', {
      ...
      path: '/posts/:_id',
      controller: [PostsDailyController, PostPageController],
      yieldTemplates: {
        'post_page': {to: 'modal-pane'}
      },
      onAfterAction: function() {
        $(".overlay").toggleClass("hidden", false);
        $("body").toggleClass("modal-pane-open", true);
      }
    });
    ...
    this.route('comment_reply', {
      template: getTemplate('posts_daily'),
      path: '/comments/:_id',
      controller: [PostsDailyController, CommentPageController],
      yieldTemplates: {
        'comment_reply': {to: 'modal-pane'}
      },
      onAfterAction: function() {
        window.queueComments = false;
        $(".overlay").toggleClass("hidden", false);
    ...
    this.route('user_edit', {
      ...
      controller: [PostsDailyController, UserPageController],
      yieldTemplates: {
        'user_edit': {to: 'modal-pane'}
      },
      onAfterAction: function() {
        $(".overlay").toggleClass("hidden", false);
        $("body").toggleClass("modal-pane-open", true);
    ...
    this.route('account', {
      template: getTemplate('posts_daily'),
      path: '/account',
      controller: [PostsDailyController, AccountController],
      yieldTemplates: {
        'user_edit': {to: 'modal-pane'}
      },
      onAfterAction: function() {
